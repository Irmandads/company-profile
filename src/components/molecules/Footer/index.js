    ...
    return (
        <div>
            <footer className="p-20 footer text-base-100" style={{ backgroundColor: "#e5e7eb" }}>
                <div>
                    <Link to="/">
                        <img src={logoMSN} alt="MSN PRODUCTION" className="w-20 sm:w-46" />
                    </Link>
                    ...
                    <div className="flex items-center mt-4">
                        <a href="https://www.linkedin.com/in/mulia-sejati-nusantara-production-a766b3258/" target="blank" className="text-2xl text-accent hover:text-primary hover:-translate-y-1.5 shadow-lg mx-1 duration-300">
                            <FaLinkedin></FaLinkedin>
                        </a>
                        <a href="https://web.facebook.com/profile.php?id=100088222058988" target="blank" className="text-2xl text-accent hover:text-primary hover:-translate-y-1.5 shadow-lg mx-1 duration-300">
                            <FaFacebookSquare></FaFacebookSquare>
                        </a>
                        <a href="https://twitter.com/MSN_Production" target="blank" className="text-2xl text-accent hover:text-primary hover:-translate-y-1.5 shadow-lg mx-1 duration-300">
                            <FaTwitterSquare></FaTwitterSquare>
                        </a>
                        <a href="https://www.instagram.com/msn.production/" target="blank" className="text-2xl text-accent hover:text-primary hover:-translate-y-1.5 shadow-lg mx-1 duration-300">
                ...
                <div>
                    ...
                    <Link to="/tentang" className="link link-hover hover:text-primary text-accent">
                        <span>Tentang</span>
                    </Link>
                    <Link to="/paket" className="link link-hover hover:text-primary text-accent">
                        <span>Paket</span>
                    </Link>
                    <Link to="/kontak" className="link link-hover hover:text-primary text-accent">
                        <span>Kontak</span>
                    </Link>
                ...
                <div className="">
                    <span className="font-bold text-accent">Office</span>
                    <span className="text-accent">
                        Jl. Lorem, ipsum. <br /> Lorem ipsum dolor sit. <br /> Jawa Timur
                    </span>
                </div>
            </footer>
            <footer className="px-10 py-6 text-sm text-center text-base-100 border-base-300 bg-neutral ">
                ...
                <div className="flex flex-col items-center justify-center mt-6 md:flex-row text-accent">
                    <p>&copy; Copyright 2024, PT. Satellite. All Rights Reserved</p>
                </div>
            </footer>
            {/* <ButtonWa /> */}
        </div>
