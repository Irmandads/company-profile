...
const Diskusi = () => {
    ...
    return (
        <div className="my-10 py-16 parent">
            <motion.div ref={ref} initial="hidden" animate={viewDiv && "visible"} variants={sectionBodyAnimation}>
                <RevealEffect bottom>
                    <section className="flex h-80  items-center container mx-auto justify-center">
                        <div className="flex flex-col w-10/12 sm:w-11/12 xl:w-10/12 rounded-2xl bg-blue-400 text-gray-100 py-14 sm:px-12 sm:py-20 xl:px-16 shadow-2xl discuss">
                            <div className="flex flex-col sm:flex-row mb-3 sm:mb-9 p-5 sm:p-0 sm:items-center">
                                ...
                                <Button
                                    href="/kontak"
                                    type="link"
                                    className="flex bg-white bg-white text-blue-800 text-xl font-semibold lg:text-2xl xl:text-xl tracking-wider items-center justify-center w-56 lg:w-96 lg:h-24 xl:w-56 h-20 p-5 border-2 border-white shadow-xl rounded-full mt-6 sm:mt-0 sm:ml-4 lg:ml-0 xl:ml-12 transform transition duration-600 hover:scale-105"
                                >
                                    Lets Discuss!
                                </Button>
                            </div>
